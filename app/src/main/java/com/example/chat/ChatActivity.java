...
import com.example.chat.presenter.ChatPresenter;
import com.example.chat.presenter.ChatPresenterImpl;
import com.example.chat.presenter.UserListPresenter;
import com.example.chat.presenter.UserListPresenterImpl;
import com.example.chat.view.ChatContract;
import com.example.chat.view.UserListContract;
...
public class ChatActivity extends AppCompatActivity implements UserListContract, ChatContract {
    ...
    private ImageButton btnHomeChat;
    private ImageButton btnSentingProfile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHomeChat = findViewById(R.id.btnHomeChat);
        btnSentingProfile = findViewById(R.id.btnSentingProfile);
        ...
        btnSentingProfile.setOnClickListener(new View.OnClickListener() {
            @Override
